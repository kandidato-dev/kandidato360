  ...
  return (
    <div className="p-4">
      ...
      <div className="mt-12 text-center text-xs text-gray-400">
        <span>
          Disclaimer: The information on this page is generated by AI and may not be 100% accurate or up-to-date. Please verify information from official and reputable sources.
        </span>
      </div>
    </div>
  );
